...
namespace WordMatch.API.Migrations
{
    ...
    [Migration("20260730105346_AddDefaultPracticeModePreference")]
    partial class AddDefaultPracticeModePreference
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WordMatch.API.Features.Auth.ApplicationUser", b =>
                {
                    ...
                    b.Property<bool>("AutomaticallyLoadNextQuestion")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("DefaultPracticeMode")
                        .HasColumnType("text");
                    ...
                    b.ToTable("AspNetUsers", null, t =>
                        {
                            t.HasCheckConstraint("CK_AspNetUsers_DefaultPracticeMode", "\"DefaultPracticeMode\" IS NULL OR \"DefaultPracticeMode\" IN ('EnglishToTurkish', 'TurkishToEnglish', 'Mixed')");
                        });
                });
            ...
            modelBuilder.Entity("WordMatch.API.Features.Practice.PracticeSessionWord", b =>
                {
                    ...
                    b.HasIndex("PracticeSessionId", "WordId", "Direction")
                        .IsUnique();

                    b.ToTable("PracticeSessionWords", null, t =>
                        {
                            t.HasCheckConstraint("CK_PracticeSessionWords_Answer", "(\"Outcome\" IS NULL AND \"SelectedIndex\" IS NULL AND \"AnsweredAtUtc\" IS NULL) OR (\"Outcome\" IS NOT NULL AND \"AnsweredAtUtc\" IS NOT NULL)");
            ...
            modelBuilder.Entity("WordMatch.API.Features.Practice.UserWordProgress", b =>
                {
                    ...
                    b.HasKey("UserId", "WordId", "Direction");
