...
namespace WordMatch.API.Migrations
{
    ...
    [Migration("20260728174942_AddIdentityAndPracticeProgress")]
    partial class AddIdentityAndPracticeProgress
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WordMatch.API.Features.Practice.PracticeSession", b =>
                {
                    ...
                    b.ToTable("PracticeSessions", null, t =>
                        {
                            t.HasCheckConstraint("CK_PracticeSessions_Category", "(\"CategoryType\" = 'Topic' AND \"Topic\" IS NOT NULL AND \"PartOfSpeech\" IS NULL) OR (\"CategoryType\" = 'PartOfSpeech' AND \"Topic\" IS NULL AND \"PartOfSpeech\" IS NOT NULL)");
                        });
                });
